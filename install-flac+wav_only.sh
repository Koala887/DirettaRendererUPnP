...
WRAPPER_EOF
    ...
    if [ -n "$EXISTING_CONFIG" ]; then
        ...
        local KNOWN_KEYS="TARGET PORT GAPLESS VERBOSE NETWORK_INTERFACE THREAD_MODE CYCLE_TIME CYCLE_MIN_TIME INFO_CYCLE TRANSFER_MODE TARGET_PROFILE_LIMIT MTU_OVERRIDE OTHER_CORE SYNC_CORE AUDIO_CORE SYNC_PRIO AUDIO_PRIO NICE_LEVEL IO_SCHED_CLASS IO_SCHED_PRIORITY"
        local migrated_keys=""
        local obsolete_keys=""
